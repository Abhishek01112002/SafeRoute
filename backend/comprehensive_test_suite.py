...
class SafeRouteTestSuite:
    ...
    def generate_report(self) -> Dict:
        ...
        critical_failures = sum(1 for r in self.results if r.severity == "Critical" and r.status != TestStatus.PASS)
        high_failures = sum(1 for r in self.results if r.severity == "High" and r.status != TestStatus.PASS)
