...
from backend.database import get_db, save_tourist, load_tourists
...
async def register_tourist(body: TouristRegister):
    ...
    # Identity hash (blockchain anchor)
    identity_payload = json.dumps(
        {"tourist_id": tid, "document_type": body.document_type,
         "document_number": body.document_number, "full_name": body.full_name},
        sort_keys=True
    )
