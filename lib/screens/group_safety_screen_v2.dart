...
class GroupSafetyScreenV2 extends StatelessWidget {
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.people_outline_rounded, size: 80, color: isDark ? Colors.white10 : Colors.black12),
  ...
  Widget _buildMemberList(BuildContext context, RoomProvider room, ThemeData theme, bool isDark) {
    return ListView(
      ...
      children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Location Visibility", style: TextStyle(fontWeight: FontWeight.bold)),
                        Text(
                          "Allow team to see your live dot", 
        ...
        EliteButton(
          ...
          child: const Text('ABANDON MISSION', style: TextStyle(color: AppColors.danger)),
        ),
      ...
      child: EliteSurface(
        ...
        child: Row(
          children: [
            CircleAvatar(
              radius: 20,
              backgroundColor: online ? AppColors.success.withOpacity(0.2) : Colors.white10,
              child: Text(
                name[0].toUpperCase(),
                style: TextStyle(color: online ? AppColors.success : Colors.white30, fontWeight: FontWeight.bold),
              ),
            ),
            const SizedBox(width: 16),
            Expanded(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: TextStyle(fontSize: 10, color: isDark ? Colors.white60 : Colors.black87),
            ),
          ),
        ],
      ),
          ...
          TextButton(
            onPressed: () {
              if (controller.text.isNotEmpty) {
                final tourist = context.read<TouristProvider>().tourist;
                if (tourist != null) {
                   context.read<RoomProvider>().createAndJoinRoom(
                    userId: tourist.touristId,
                    name: tourist.fullName,
                  );
                }
