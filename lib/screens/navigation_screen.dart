...
class _NavigationScreenState extends State<NavigationScreen>
  ...
  Future<void> _detectAndSetMode() async {
    ...
    setState(() {
      _mode = (connectivityResult == ConnectivityResult.none)
          ? _NavMode.offline
          : _NavMode.online;
    });
  }
          ...
          RepaintBoundary(
            child: FlutterMap(
              ...
              options: MapOptions(
                ...
                maxZoom: 18.5,
                onMapEvent: (e) {
                  if ((e is MapEventScrollWheelZoom || e is MapEventMove) &&
              ...
              children: [
                TileLayer(
                  urlTemplate:
                      'https://mt1.google.com/vt/lyrs=$_mapType&x={x}&y={y}&z={z}',
        ...
        children: [
          Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color:
                      isOnline ? AppColors.zoneGreen : AppColors.zoneYellow)),
          const SizedBox(width: 8),
          Text(isOnline ? "HYBRID ONLINE" : "OFFLINE ENGINE",
              style: const TextStyle(
                  color: Colors.white,
                  fontSize: 9,
                  fontWeight: FontWeight.w900,
          ...
          _mapActionBtn(
              ...
              onTap: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            TacticalARScreen(targetDestination: target)));
              }),
        ],
      ),
    );
  ...
  Widget _mapTypeOption(String label, IconData icon, String type, bool active) {
    ...
    return EliteButton(
      ...
      child: Row(
        children: [
          Icon(icon,
              size: 20, color: isSelected ? Colors.white : Colors.white60),
  ...
  Widget _mapActionBtn(
    ...
    return EliteSurface(
      ...
      child: IconButton(
        icon: Icon(icon,
            color: active ? AppColors.primary : Colors.white60, size: 20),
        onPressed: onTap,
      ),
    );
  }
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(
                  "${(_navResult!.totalDistanceMeters / 1000).toStringAsFixed(1)} KM",
                  style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.w900,
                      fontSize: 13)),
                ...
                child: Column(
                  ...
                  Text("SOS BROADCAST ACTIVE",
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w900,
                          fontSize: 11)),
                  Text("RESCUE CENTERS MONITORING...",
                      style: TextStyle(color: Colors.white70, fontSize: 8))
                ])),
            IconButton(
                onPressed: () =>
                    context.read<LocationProvider>().setSosActive(false),
  ...
  Widget _buildZonesLayer() {
    return PolygonLayer(
      polygons: [
        ...
        Polygon(
          points: const [
            LatLng(30.3369, 77.8696),
            LatLng(30.3367, 77.8702),
            LatLng(30.3345, 77.8709),
            LatLng(30.3355, 77.8684)
          ],
        ...
        return Stack(
          ...
          children: [
            ...
            Opacity(
              ...
              child: Container(
                width: 60 * pulse.value,
                height: 60 * pulse.value,
                decoration: BoxDecoration(
                    shape: BoxShape.circle,
