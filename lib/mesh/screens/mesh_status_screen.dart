...
class _MeshStatusScreenState extends State<MeshStatusScreen> {
        ...
        SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text("MESH IDENTITY", style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.38), fontWeight: FontWeight.w900, fontSize: 9, letterSpacing: 1.5)),
                        const Spacer(),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Text("NODE ID:", style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.5), fontSize: 9, fontWeight: FontWeight.w900)),
              ...
              Text("NEARBY NODES (SIMPLE VIEW)", style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.38), fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2)),
              const SizedBox(height: AppSpacing.m),
              ...
              if (_showAdvanced) ...[
                const SizedBox(height: AppSpacing.xl),
                Text("NETWORK TRAFFIC (ADVANCED)", style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.38), fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2)),
                const SizedBox(height: AppSpacing.m),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text("BLE MESH NETWORK ACTIVE", style: TextStyle(color: theme.colorScheme.onPrimary.withOpacity(0.6), fontWeight: FontWeight.bold, fontSize: 8)),
                ],
              ),
              const Spacer(),
  ...
  Widget _headerStat(String label, String value) {
    ...
    return Column(
      children: [
        ...
        Text(label, style: TextStyle(color: theme.colorScheme.onPrimary.withOpacity(0.38), fontWeight: FontWeight.w900, fontSize: 7, letterSpacing: 0.5)),
      ],
    );
  }
    ...
    if (mesh.nearbyNodes.isEmpty) {
      return EliteSurface(
        ...
        child: Center(
          child: Column(
            children: [
              Icon(Icons.sensors_off_rounded, color: theme.colorScheme.onSurface.withOpacity(0.1), size: 32),
              const SizedBox(height: AppSpacing.m),
              Text("SCANNING FOR SIGNALS...", style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.24), fontSize: 9, fontWeight: FontWeight.w900)),
            ],
          ),
        ),
      );
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text('NODE: ${node.userId}', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.38), fontSize: 8, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
  ...
  Widget _buildActivityList(MeshProvider mesh) {
    ...
    if (mesh.recentActivity.isEmpty) {
      return Center(child: Text('NO MESH TRAFFIC DETECTED', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.1), fontSize: 9, fontWeight: FontWeight.w900)));
    }
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('SOURCE: ${packet.sourceId.substring(0, 8)}...', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.38), fontSize: 8, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  Text(timeStr, style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.24), fontSize: 9, fontWeight: FontWeight.w900)),
                ],
              ),
              if (packet.relayPathShortIds.isNotEmpty) ...[
                ...
                Text("MESH PEER ROUTE", style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.1), fontSize: 7, fontWeight: FontWeight.w900, letterSpacing: 1)),
                const SizedBox(height: AppSpacing.s),
                Wrap(
                  spacing: 4,
                  children: [
  ...
  Widget _hopDot(String label, {bool isMe = false}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isMe ? theme.colorScheme.primary.withOpacity(0.1) : theme.colorScheme.onSurface.withOpacity(0.05),
        borderRadius: BorderRadius.circular(4),
        border: Border.all(color: isMe ? theme.colorScheme.primary : theme.dividerColor),
      ),
      child: Text(label, style: TextStyle(color: isMe ? theme.colorScheme.onSurface : theme.colorScheme.onSurface.withOpacity(0.24), fontSize: 7, fontWeight: FontWeight.bold)),
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: theme.colorScheme.onPrimary.withOpacity(0.24))
        ),
