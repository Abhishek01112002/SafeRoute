  ...
  Widget build(BuildContext context) {
    ...
    switch (status) {
      ...
      case ZoneType.greenInner:
        ...
        gradient = LinearGradient(colors: [AppColors.zoneGreen, AppColors.zoneGreen.withOpacity(0.7)]);
        icon = Icons.shield_moon_rounded;
        description = "You are under active protection. Stay within the perimeter.";
        break;
      case ZoneType.yellow:
        primaryColor = AppColors.zoneYellow;
        gradient = LinearGradient(colors: [AppColors.zoneYellow, const Color(0xFFF59E0B)]);
        icon = Icons.gpp_maybe_rounded;
        description = "Cuation required. Boundary drift detected.";
        break;
      case ZoneType.red:
        primaryColor = AppColors.zoneRed;
        gradient = LinearGradient(colors: [AppColors.zoneRed, const Color(0xFFB91C1C)]);
    ...
    return EliteSurface(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
             BoxShadow(color: primaryColor.withOpacity(isDark ? 0.08 : 0.05), blurRadius: 40, spreadRadius: -10)
          ],
        ),
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(title,
                          style: TextStyle(color: isDark ? Colors.white : primaryColor.withOpacity(0.9), fontWeight: FontWeight.w900, fontSize: 16, letterSpacing: 0.5)),
                        Text("MISSION PERIMETER",
                          style: TextStyle(color: (isDark ? Colors.white : Colors.black).withOpacity(0.3), fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1.5)),
                      ],
                    ),
                  ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(description,
                    style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.7), fontSize: 13, height: 1.5, fontWeight: FontWeight.w500)),
                  ...
                  Stack(
                    children: [
                      ...
                      AnimatedContainer(
                        ...
                        height: 6,
                        width: MediaQuery.of(context).size.width * 0.4, // Mock distance
                        decoration: BoxDecoration(
                          gradient: gradient,
                          borderRadius: BorderRadius.circular(10),
...
class _PulsingLiveIndicatorState extends State<_PulsingLiveIndicator> with SingleTickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text("LIVE", style: TextStyle(color: widget.color, fontSize: 9, fontWeight: FontWeight.w900)),
        ],
      ),
    );
  }
