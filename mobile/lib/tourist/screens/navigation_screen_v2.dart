...
// tile_downloader_service import removed — download feature disabled
...
class _NavigationScreenV2State extends State<NavigationScreenV2> {
  ...
  // Download feature removed — tiles load lazily via DatabaseTileProvider
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Offline download panel removed — tiles cache lazily
        ],
      ),
    );
  }
