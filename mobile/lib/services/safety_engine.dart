...
class SafetyEngine {
  ...
  static SafetyRiskLevel calculateRisk({
    ...
    // 3. CAUTION zone, syncing state, or low battery (< 25%)
    // syncing = can't confirm safety yet → treat as medium risk
    if (zone == ZoneType.caution || zone == ZoneType.syncing || batteryLevel < 0.25) {
